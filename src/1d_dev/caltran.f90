SUBROUTINE CALTRAN (ISTL_,IS2TL_,MVAR,MO,CON,CON1,IT)  
  ...
  300 CONTINUE  
  DO K=1,KC  
    DO LP=1,LLWET(K,0) ! *** Total Wet Cells for Layer K
      L=LKWET(LP,K,0)  ! *** Wet Cell for Layer K
  ...
  !LLWET   ! *** NUMBER OF ACTIVE CELLS FOR EACH LAYER BY DOMAIN.  ND=0 FOR ENTIRE LAYER!           
